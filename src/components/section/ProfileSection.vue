                      ...
                      <div class="row g-gs">
                          ...
                          <div class="card card-full">
                              <div class="card-image">
                                  <img :src="product.assetUrl" class="card-img-top" alt="art image">
                              </div>
                              <div class="card-body p-4">
                                  <h5 class="card-title text-truncate mb-0">{{ product.assetName  }}</h5>
                                  <div class="card-author mb-1 d-flex align-items-center">
                                      <span class="me-1 card-author-by">By</span>
                                      <div class="custom-tooltip-wrap">
                                          <router-link :to="product.creatorName" class="custom-tooltip author-link">{{ product.creatorName }}</router-link>
